...
class BaseTeam(ABC):
    ...
    def get_statistics(self):
        ...
        return f"Name: {self.name}\n"\
               ...
               f"Average Protection: {int(average_protection)}"

    #helper_method
    def sum_points(self):
        total_protection_points = sum([p.protection for p in self.equipment])
        return self.advantage + total_protection_points
