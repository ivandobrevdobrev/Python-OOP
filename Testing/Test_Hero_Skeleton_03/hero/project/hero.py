class Hero:
    ...
    def battle(self, enemy_hero):
        ...
        player_damage = self.damage * self.level  #27.5
        enemy_hero_damage = enemy_hero.damage * enemy_hero.level #22.8

        self.health -= enemy_hero_damage #-13.8
        enemy_hero.health -= player_damage #-18.5
